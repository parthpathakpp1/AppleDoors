    ...
    <div className="door-card">
      ...
      <div className="door-content">
        ...
        <div className="button-container">
          <Link to={`/customization/${encodeURIComponent(doorName)}`}> {/* Update this line */}
            <motion.button className="btn-customize">Customize</motion.button>
          </Link>
          <Link to="/"> {/* Your existing code */}
            <motion.button className="btn-add-to-cart">Add to Cart</motion.button>
          </Link>
        </div>
      </div>
    </div>
